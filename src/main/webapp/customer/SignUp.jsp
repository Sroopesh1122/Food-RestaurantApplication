...
<body>
	<section class="center signup-section">
		...
		<form action="<%=request.getContextPath()+"/customer/register" %>" method="post" id="signupForm">
			<h4 class="text-center mb-3">Sign Up</h4>

			<div class="form-group mb-1">
				<label for="name">Name</label> <input type="text"
					class="form-control" id="name" name="name">
				<div class="error">Please enter name</div>
			</div>
			...
			<p class="text-center signup-footer">
				Already have an account ? <a href="<%=request.getContextPath() + "/customer/Login.jsp"%>">Login</a>
			</p>

		</form>
	</section>
	
	<script type="text/javascript" src="<%=request.getContextPath() + "/customer/js/SignUp.js"%>"></script>
	<%
